...
from local_explorer_agent.app.agent.skills.place_selection import _is_open_at
...
def test_place_selection_open_hours_helper_handles_evening_exhibition() -> None:
    ...
    assert _is_open_at(closed_gallery, start_time) is False
    assert _is_open_at(open_gallery, start_time) is True
